...
function PhotoUploader({ addedPhotos, onChange }) {
  ...
  return (
    <>
      ...
      <div className=" mt- gap-2 grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6">
          ...
          addedPhotos.map((link) => (
            <div className="relative h-32 flex" key={link}>
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-0 right-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3"
              >
                <svg
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-0 left-1 text-white bg-black bg-opacity-50 rounded-2xl py-2 px-3"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
